...
class UpdateFreeUseCaseImpl @Inject constructor(private val freeRepo: FreeRepo): UpdateFreeUseCase {
...
class DeleteFreeUseCaseImpl @Inject constructor(private val freeRepo: FreeRepo): DeleteFreeUseCase {
    override suspend fun invoke(): Flow<DataResult<Free>> {
        return freeRepo.updateFree()
    }
}